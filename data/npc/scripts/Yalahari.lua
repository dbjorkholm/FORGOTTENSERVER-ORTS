...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if(p:getStorageValue( 30) == 17) then
			...
			p:setStorageValue( 30, 18)
			p:setStorageValue(12014, 3) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 650) == 1 and p:getStorageValue( 30) == 18) then
			...
			p:setStorageValue( 30, 19)
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 19) then
			...
			p:setStorageValue( 30, 20)
			p:setStorageValue(12014, 4) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 21 and p:getStorageValue( 651) == 1) then
			npcHandler:say("So you have killed the plague carriers. Have you also retrieved the research papers? ", cid)
			talkState[talkUser] = 1
		elseif(p:getStorageValue( 30) == 22) then
			...
			p:setStorageValue( 30, 23)
			p:setStorageValue(12015, 1) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 26) then
			...
			p:setStorageValue( 30, 27)
			p:setStorageValue(12015, 6) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 25 and p:getStorageValue( 18) == 2) then
			...
			p:setStorageValue( 20, p:getStorageValue( 20) >= 0 and p:getStorageValue( 20) + 1 or 0) -- Side Storage
			p:setStorageValue( 30, 27)
			p:setStorageValue(12015, 6) -- StorageValue for Questlog "Mission 04: Good to be Kingpin"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 27) then
			...
			p:setStorageValue( 30, 28)
			p:setStorageValue(12016, 1) -- StorageValue for Questlog "Mission 05: Food or Fight"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 33) then
			...
			p:setStorageValue( 30, 34)
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 32 and p:getStorageValue( 16) == 2) then
			...
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 34) then
			...
			p:setStorageValue( 30, 35)
			p:setStorageValue(12017, 1) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
			doPlayerAddItem(cid, 9737, 1)
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 38) then
			...
			p:setStorageValue( 30, 39)
			p:setStorageValue(12017, 5) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 37) then
			if(getPlayerItemCount(cid, 9742) >= 1) then
				...
				p:setStorageValue( 30, 39)
				p:setStorageValue(12017, 5) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
				p:setStorageValue( 14, 2)
				p:setStorageValue( 20, p:getStorageValue( 20) >= 0 and p:getStorageValue( 20) + 1 or 0) -- Side Storage
				talkState[talkUser] = 0
			end
		elseif(p:getStorageValue( 30) == 39) then
			...
			p:setStorageValue( 30, 40)
			p:setStorageValue(12018, 1) -- StorageValue for Questlog "Mission 07: A Fishy Mission"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 41 and p:getStorageValue( 11) == 1 and p:getStorageValue( 12) == 1 and p:getStorageValue( 13) == 1 and p:getStorageValue( 14) == 2) then
			...
			p:setStorageValue( 20, p:getStorageValue( 20) >= 0 and p:getStorageValue( 20) + 1 or 0) -- Side Storage
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 43) then
			...
			p:setStorageValue( 30, 44)
			p:setStorageValue(12019, 1) -- StorageValue for Questlog "Mission 08: Dangerous Machinations"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 46) then
			if(p:getStorageValue( 9) == 1) then
			...
			elseif(p:getStorageValue( 9) == 2) then
				npcHandler:say("Now we will have power we truly deserve!...", cid)
				p:setStorageValue( 20, p:getStorageValue( 20) >= 0 and p:getStorageValue( 20) + 1 or 0) -- Side Storage
			end
			p:setStorageValue( 30, 47)
			p:setStorageValue(12019, 4) -- StorageValue for Questlog "Mission 08: Dangerous Machinations"
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 47) then
			...
			p:setStorageValue( 30, 48)
			p:setStorageValue(12020, 1) -- StorageValue for Questlog "Mission 09: Decision"
			talkState[talkUser] = 0
		...
		elseif(p:getStorageValue( 30) == 50 and p:getStorageValue( 8) == 2) then
			...
			p:setStorageValue( 1015, 2)
			talkState[talkUser] = 0
		elseif(p:getStorageValue( 30) == 52 and p:getStorageValue( 1015) == 2) then
	...
	elseif(msgcontains(msg, "yes")) then
		if(talkState[talkUser] == 1) then
			if(getPlayerItemCount(cid, 9733) >= 1) then
				...
				p:setStorageValue( 20, 1)
				p:setStorageValue( 30, 22)
				p:setStorageValue(12014, 6) -- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
