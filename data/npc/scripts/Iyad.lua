...
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I can fly you to {Darashia} on Darama, {Femor Hills}, {Kazordoon} or {Edron} if you like. Where do you want to go?"})
