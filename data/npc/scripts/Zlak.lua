...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(1060) == 22 then
			...
			player:setStorageValue(1060, 23)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(1060) == 23 then
			...
			player:setStorageValue(1060, 24)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(1060) == 25 then
			...
			player:setStorageValue(1060, 26)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(1060) == 26 then
			...
			player:setStorageValue(1060, 27)
			npcHandler.topic[cid] = 0
		end
	end
	return true
