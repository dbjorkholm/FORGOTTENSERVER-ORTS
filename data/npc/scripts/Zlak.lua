...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 22 then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 23)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 23 then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 24)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 25 then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 26)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 26 then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 27)
			npcHandler.topic[cid] = 0
		end
	end
	return true
