...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 32 and player:getStorageValue(1090) == 5 then
		...
		elseif player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 34 then
			...
			player:setStorageValue(Storage.WrathoftheEmperor.Questline, 35)
