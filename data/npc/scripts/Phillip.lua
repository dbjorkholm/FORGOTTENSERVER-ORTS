...
keywordHandler:addKeyword({'time'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "It is " .. getTibianTime() .. "."})
...
keywordHandler:addKeyword({'sewer'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "An interesting place you should consider to visit."})
keywordHandler:addKeyword({'thank you'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "You don't have to thank me, it's only my duty."})
...
keywordHandler:addKeyword({'rumour'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I don't like rumours."})
keywordHandler:addKeyword({'gossip'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I don't like rumours."})
keywordHandler:addKeyword({'news'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I don't like rumours."})
...
keywordHandler:addKeyword({'in tod we trust'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Tod will come and save us all. He will bring freedom and beer to the men of Carlin."})
