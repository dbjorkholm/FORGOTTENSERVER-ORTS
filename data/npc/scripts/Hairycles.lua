...
if player:getStorageValue(TheApeCity.Questline) >= 23 then
...
function greetCallback(cid)
	...
	if(player:getStorageValue(TheApeCity.Questline) <= 14) then
		npcHandler:setMessage(MESSAGE_GREET, "Oh! Hello! Hello! Did not notice!")
	elseif(player:getStorageValue(TheApeCity.Questline) >= 15) then
...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "heal") then
		if player:getStorageValue(TheApeCity.Mission06) >= 3 then
	...
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(TheApeCity.Questline) < 1 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 1 then
			npcHandler:say("Oh, you brought me whisper moss? Good hairless ape you are! Can me take it?", cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(TheApeCity.Questline) == 2 then
			...
			player:setStorageValue(TheApeCity.Questline, 3)
			player:setStorageValue(TheApeCity.Mission02, 1) -- The Ape City Questlog - Mission 2: The Cure
		elseif player:getStorageValue(TheApeCity.Questline) >= 3 and player:getStorageValue(TheApeCity.Questline) <= 6 then
			npcHandler:say("You brought me that cough syrup from human healer me asked for?", cid)
			npcHandler.topic[cid] = 4
		elseif player:getStorageValue(TheApeCity.Questline) == 7 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 8 then
			npcHandler:say("You got scroll from lizard village in south east?", cid)
			npcHandler.topic[cid] = 7
		elseif player:getStorageValue(TheApeCity.Questline) == 9 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 10 then
			npcHandler:say("Ah yes, you read the signs in tomb? Good! May me look into your mind to see what you saw?", cid)
			npcHandler.topic[cid] = 9
		elseif player:getStorageValue(TheApeCity.Questline) == 11 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 12 then
			npcHandler:say("You bring Hairycles egg of hydra?", cid)
			npcHandler.topic[cid] = 11
		elseif player:getStorageValue(TheApeCity.Questline) == 13 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 14 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 16 then
			npcHandler:say("Your mission is to take crowbar and destroy three of them casks to stop this madness.", cid)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(TheApeCity.Questline) == 17 then
			...
			player:setStorageValue(TheApeCity.Questline, 18)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(TheApeCity.Questline) == 18 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 20 then
		...
		elseif player:getStorageValue(TheApeCity.Questline) == 21 then
			npcHandler:say("Your mission is to destroy the Cobra Statue in deep Banuta.", cid)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(TheApeCity.Questline) == 22 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 2 then	
			...
			player:setStorageValue(TheApeCity.Questline, 1)
			player:setStorageValue(TheApeCity.Mission01, 1) -- The Ape City Questlog - Mission 1: Whisper Moss
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 3 then
			if player:getItemCount(4838) >= 1 then
				...
				player:setStorageValue(TheApeCity.Questline, 2)
				player:setStorageValue(TheApeCity.Mission01, 2) -- The Ape City Questlog - Mission 1: Whisper Moss
				npcHandler.topic[cid] = 0	
			else
		...
		elseif npcHandler.topic[cid] == 4 then
			if player:getItemCount(4839) >= 1 then
				...
				player:setStorageValue(TheApeCity.Questline, 7)
				player:setStorageValue(TheApeCity.Mission02, 5) -- The Ape City Questlog - Mission 2: The Cure
				npcHandler.topic[cid] = 0	
			else
				npcHandler:say("You don't have it...", cid)
			end
		...
		elseif npcHandler.topic[cid] == 6 then	
			...
			player:setStorageValue(TheApeCity.Questline, 8)
			player:setStorageValue(TheApeCity.Mission03, 1) -- The Ape City Questlog - Mission 3: Lizard Parchment
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 7 then
			if player:getItemCount(5956) >= 1 then
				...
				player:setStorageValue(TheApeCity.Questline, 9)
				player:setStorageValue(TheApeCity.Mission03, 2) -- The Ape City Questlog - Mission 3: Lizard Parchment
				npcHandler.topic[cid] = 0	
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 8 then	
			...
			player:setStorageValue(TheApeCity.Questline, 10)
			player:setStorageValue(TheApeCity.Mission04, 1) -- The Ape City Questlog - Mission 4: Parchment Decyphering
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 9 then
			if player:getStorageValue(TheApeCity.Mission04) == 2 then
				...
				player:setStorageValue(TheApeCity.Questline, 11)
				player:setStorageValue(TheApeCity.Mission04, 3) -- The Ape City Questlog - Mission 4: Parchment Decyphering
				npcHandler.topic[cid] = 0	
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 10 then	
			...
			player:setStorageValue(TheApeCity.Questline, 12)
			player:setStorageValue(TheApeCity.Mission05, 1) -- The Ape City Questlog - Mission 5: Hydra Egg
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 11 then
			if player:getItemCount(4850) >= 1 then
				...
				player:setStorageValue(TheApeCity.Questline, 13)
				player:setStorageValue(TheApeCity.Mission05, 3) -- The Ape City Questlog - Mission 5: Hydra Egg
				npcHandler.topic[cid] = 0	
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 12 then	
			...
			player:setStorageValue(TheApeCity.Questline, 14)
			player:setStorageValue(TheApeCity.Mission06, 1) -- The Ape City Questlog - Mission 6: Witches' Cap Spot
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 13 then
			if player:getItemCount(4840) >= 1 then
				...
				player:setStorageValue(TheApeCity.Questline, 15)
				player:setStorageValue(TheApeCity.Mission06, 3) -- The Ape City Questlog - Mission 6: Witches' Cap Spot
				npcHandler.topic[cid] = 0	
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 14 then	
			...
			player:setStorageValue(TheApeCity.Questline, 16)
			player:setStorageValue(TheApeCity.Mission07, 1) -- The Ape City Questlog - Mission 7: Destroying Casks With Crowbar
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 15 then	
			npcHandler:say("Hairycles proud of you. Go and find holy hair. Good luck, friend.", cid)
			player:setStorageValue(TheApeCity.Questline, 19)
			player:setStorageValue(TheApeCity.Mission08, 1) -- The Ape City Questlog - Mission 8: Looking for a hair of holy ape
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 16 then
			if player:getItemCount(4843) >= 1 then
				...
				player:setStorageValue(TheApeCity.Questline, 20)
				player:setStorageValue(TheApeCity.Mission08, 3) -- The Ape City Questlog - Mission 8: Looking for a hair of holy ape
				npcHandler.topic[cid] = 0	
			else
				npcHandler:say("You don't have it...", cid)
			end
		elseif npcHandler.topic[cid] == 17 then	
			...
			player:setStorageValue(TheApeCity.Questline, 21)
			player:setStorageValue(TheApeCity.Mission09, 1) -- The Ape City Questlog - Mission 9: The Deepest Catacombs
			npcHandler.topic[cid] = 0
		elseif npcHandler.topic[cid] == 19 then	
			...
			player:setStorageValue(TheApeCity.Questline, 23)
			player:setStorageValue(TheApeCity.Mission09, 3) -- The Ape City Questlog - Mission 9: The Deepest Catacombs
			npcHandler.topic[cid] = 0
		end
