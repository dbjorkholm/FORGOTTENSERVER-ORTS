...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(TheNewFrontier.Questline) == 26 then
			...
			player:setStorageValue(TheNewFrontier.Mission09, 3) --Questlog, The New Frontier Quest "Mission 09: Mortal Combat"
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(TheNewFrontier.Mission09, 1) --Questlog, The New Frontier Quest "Mission 09: Mortal Combat"
			npcHandler.topic[cid] = 0
		end
	end
	return true
