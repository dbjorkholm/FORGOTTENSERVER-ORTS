...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") then
		if player:getStorageValue(TheNewFrontierQuestStorage) == 26 then
			...
			player:setStorageValue(TheNewFrontierQuestStorage, 27)
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(TheNewFrontierQuestStorage, 25)
