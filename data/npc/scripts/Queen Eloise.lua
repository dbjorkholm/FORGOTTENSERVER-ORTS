...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = "I am {Queen} Eloise. It is my duty to reign over this marvellous {city} and the {lands} of the north."})
...
keywordHandler:addKeyword({'land'}, StdModule.say, {npcHandler = npcHandler, text = "Soon the whole land will be ruled by {women} at last!"})
...
keywordHandler:addKeyword({'mission'}, StdModule.say, {npcHandler = npcHandler, text = "I will call for heroes as soon as the need arises again."})
keywordHandler:addKeyword({'gold'}, StdModule.say, {npcHandler = npcHandler, text = "Our city is rich and prospering."})
keywordHandler:addKeyword({'money'}, StdModule.say, {npcHandler = npcHandler, text = "Our city is rich and prospering."})
keywordHandler:addKeyword({'tax'}, StdModule.say, {npcHandler = npcHandler, text = "Our city is rich and prospering."})
...
keywordHandler:addKeyword({'food'}, StdModule.say, {npcHandler = npcHandler, text = "Feel free to visit our town's magnificent shops."})
...
keywordHandler:addKeyword({'adventure'}, StdModule.say, {npcHandler = npcHandler, text = "We need the assistance of heroes now and then. Even males prove useful now and then."})
...
keywordHandler:addKeyword({'enemies'}, StdModule.say, {npcHandler = npcHandler, text = "Our enemies are numerous. We have to fight vile monsters and have to watch this silly king in the south carefully."})
keywordHandler:addKeyword({'thais'}, StdModule.say, {npcHandler = npcHandler, text = "They dare to reject my reign over them!"})
keywordHandler:addKeyword({'south'}, StdModule.say, {npcHandler = npcHandler, text = "They dare to reject my reign over them!"})
...
keywordHandler:addKeyword({'city'}, StdModule.say, {npcHandler = npcHandler, text = "Isn't our city marvellous? Have you noticed the lovely gardens on the roofs?"})
...
keywordHandler:addKeyword({'craftsmen'}, StdModule.say, {npcHandler = npcHandler, text = "Ask around about them."})
...
keywordHandler:addKeyword({'minotaur'}, StdModule.say, {npcHandler = npcHandler, text = "They havn't troubled our city lately. I guess, they fear the wrath of our druids."})
keywordHandler:addKeyword({'paladin'}, StdModule.say, {npcHandler = npcHandler, text = "The paladins are great hunters."})
keywordHandler:addKeyword({'legola'}, StdModule.say, {npcHandler = npcHandler, text = "The paladins are great hunters."})
...
keywordHandler:addKeyword({'trisha'}, StdModule.say, {npcHandler = npcHandler, text = "The knights of Carlin are the bravest."})
...
keywordHandler:addKeyword({'lea'}, StdModule.say, {npcHandler = npcHandler, text = "The sorcerers have a small isle for their guild. So if they blow something up it does not burn the whole city to ruins."})
...
keywordHandler:addKeyword({'padreia'}, StdModule.say, {npcHandler = npcHandler, text = "The druids of Carlin are our protectors and advisors. Their powers provide us with wealth and food."})
