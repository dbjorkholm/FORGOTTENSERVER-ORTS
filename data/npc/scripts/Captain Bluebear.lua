...
local carlinPos = Position(32387, 31820, 6)
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg,"carlin") then
		npcHandler:say("Do you want to sail to Carlin?", cid)
...
-- Commented away since we handle this in creatureSayCallback. Should be removed?
...
local travelNode = keywordHandler:addKeyword({'roshamuul'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to sail to Roshamuul?'})
