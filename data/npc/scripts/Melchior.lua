...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "word of greeting")) then
		if(getPlayerStorageValue(cid, 80) < 1) then
			setPlayerStorageValue(cid, 80, 1)
			...
			npcHandler:say({
							...
							"And keep in mind that you must choose sides in this conflict. You can only follow the Efreet or the Marid - once you have made your choice there is no way back. I know from experience that djinn do not tolerate double-crossing."}, cid, 0, 1, 4000)
		end
	end
	return true
end
