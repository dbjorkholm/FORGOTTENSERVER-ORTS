...
function creatureSayCallback(cid, type, msg)
	...
	if not npcHandler:isFocused(cid) then
		return false
	elseif(msgcontains(msg, "trouble") and player:getStorageValue( Storage.TheInquisition.TimGuard) < 1 and player:getStorageValue(Storage.TheInquisition.Mission01) ~= -1) then
