...
keywordHandler:addKeyword({'brotherhood of bones'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "... what?! Uh - no, no. Of course I wouldn't have anything to do with... them."})
