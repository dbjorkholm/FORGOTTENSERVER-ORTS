...
local travelNode = keywordHandler:addKeyword({'kazordoon'}, TravelLib.say, {npcHandler = npcHandler, onlyFocus = true, text = 'So you wish for a trip to Kazordoon? %s?', cost = 10, discount = TravelLib.postmanDiscount})
...
local travelNode = keywordHandler:addKeyword({'thais'}, TravelLib.say, {npcHandler = npcHandler, onlyFocus = true, text = 'So you wish for a trip to Thais? %s?', cost = 90, discount = TravelLib.postmanDiscount})
...
local travelNode = keywordHandler:addKeyword({'robsons isle'}, TravelLib.say, {npcHandler = npcHandler, onlyFocus = true, text = 'So you wish for a trip to Robsons Isle? %s?', cost = 70, discount = TravelLib.postmanDiscount})
...
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Where do you want me to take you? To {Kazordoon}, {Thais} or to {Robsons Isle}?'})
