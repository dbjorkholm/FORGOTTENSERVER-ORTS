...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "job") and not getPlayerStorageValue(cid, 30) == 54) then
	...
	elseif(msgcontains(msg, "job")) then
		if(getPlayerStorageValue(cid, 30) == 54) then
			npcHandler:say("Did you bring me the vampiric crest?", cid)
			talkState[talkUser] = 6
		end
	elseif(msgcontains(msg, "mission")) then
		if(getPlayerStorageValue(cid, 30) == 3) then
		...
		elseif(getPlayerStorageValue(cid, 30) == 4) then
			setPlayerStorageValue(cid, 30, 5)
		...
		elseif(getPlayerStorageValue(cid, 30) == 5) then
			npcHandler:say("So are you done with your work?", cid)
			talkState[talkUser] = 2
		elseif(getPlayerStorageValue(cid, 30) == 6) then
		...
		elseif(getPlayerStorageValue(cid, 30) >= 7 and getPlayerStorageValue(cid, 30) <= 14) then
			npcHandler:say("Did you get all the reports my superiors asked for? ", cid)
			talkState[talkUser] = 4
		elseif(getPlayerStorageValue(cid, 30) == 15) then
			...
			setPlayerStorageValue(cid, 30, 16)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 649) == 1 and getPlayerStorageValue(cid, 30) == 16) then
			...
			setPlayerStorageValue(cid, 30, 17)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 20) then
			...
			setPlayerStorageValue(cid, 30, 21)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 23) then
			...
			setPlayerStorageValue(cid, 30, 24)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 25 and getPlayerStorageValue(cid, 18) == 1) then
			...
			setPlayerStorageValue(cid, 21, getPlayerStorageValue(cid, 21) >= 0 and getPlayerStorageValue(cid, 21) + 1 or 0)
			setPlayerStorageValue(cid, 30, 26)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 28) then	
			...
			setPlayerStorageValue(cid, 30, 29)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 32 and getPlayerStorageValue(cid, 16) == 1) then
			...
			setPlayerStorageValue(cid, 30, 33)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 35) then
			...
			setPlayerStorageValue(cid, 30, 36)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 37) then
			if(getPlayerItemCount(cid, 9742) >= 1) then
				...
				setPlayerStorageValue(cid, 30, 38)
				setPlayerStorageValue(cid, 14, 1)
				setPlayerStorageValue(cid, 21, getPlayerStorageValue(cid, 21) >= 0 and getPlayerStorageValue(cid, 21) + 1 or 0) -- Side Storage
				talkState[talkUser] = 0
			end
		elseif(getPlayerStorageValue(cid, 30) == 40) then
			...
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 42 and getPlayerStorageValue(cid, 14) == 1) then
			...
			setPlayerStorageValue(cid, 21, getPlayerStorageValue(cid, 21) >= 0 and getPlayerStorageValue(cid, 21) + 1 or 0) -- Side Storage
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 44) then
			...
			setPlayerStorageValue(cid, 30, 45)
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 48) then
			...
			setPlayerStorageValue(cid, 30, 49)
			talkState[talkUser] = 0
		...
		elseif(getPlayerStorageValue(cid, 30) == 50 and getPlayerStorageValue(cid, 8) == 1) then
			...
			talkState[talkUser] = 0
		elseif(getPlayerStorageValue(cid, 30) == 52 and getPlayerStorageValue(cid, 1015) == 1) then
	...
	elseif(msgcontains(msg, "yes")) then
		if(talkState[talkUser] == 1) then
			setPlayerStorageValue(cid, 30, 4)
		...
		elseif(talkState[talkUser] == 2) then
			if(getPlayerStorageValue(cid, 26) == 1 and getPlayerStorageValue(cid, 27) == 1 and getPlayerStorageValue(cid, 28) == 1 and getPlayerStorageValue(cid, 29) == 1) then
				setPlayerStorageValue(cid, 30, 6)
		...
		elseif(talkState[talkUser] == 3) then
			setPlayerStorageValue(cid, 30, 7)
		...
		elseif(talkState[talkUser] == 4) then
			if(getPlayerStorageValue(cid, 30) == 14) then
				setPlayerStorageValue(cid, 30, 15)
		...
		elseif(talkState[talkUser] == 6) then
			if(getPlayerItemCount(cid, 9956) >= 1 and getPlayerStorageValue(cid, 30) == 54) then
				setPlayerStorageValue(cid, 30, 55)
				npcHandler:say("Great! Here, take this yalaharian addon in a return.", cid)
				doPlayerAddOutfit(cid, getPlayerSex(cid) == 0 and 324 or 325, getPlayerStorageValue(cid, 8) == 1 and 1 or 2)
				talkState[talkUser] = 0
			else
				npcHandler:say("Come back when you do.", cid)
				talkState[talkUser] = 0
