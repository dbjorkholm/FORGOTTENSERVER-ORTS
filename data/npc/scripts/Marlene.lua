...
keywordHandler:addKeyword({'thank you'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "My pleasure, I always enjoy sharing interesting stories."})

local function creatureSayCallback(cid, type, msg)
	if not npcHandler:isFocused(cid) then
		return false
	elseif msgcontains(msg, "seamonster") then
		npcHandler:say({'Only some days ago I was at the docks late in the night and was looking for my husband\'s ship when suddenly a known noise appeared near the docks. ...',
		...
		'Just go to the docks at exactly midnight and be very quiet. Look at the horizon and maybe you will hear and see it, too!'}, cid)
	elseif msgcontains(msg, "aneus") then
		npcHandler:say({'A very nice person. He has a great story to tell with big fights and much magic. Just ask him for his story. ...',
		...
		'Maybe I can also find a lovely new dress for me. I have been looking for one for months now but never found a good one. Maybe... *keeps on babbling*'}, cid)
	elseif msgcontains(msg, "rumours") then
		npcHandler:say({'Well, I heard about evil beings living in a dungeon below us. So once I tried to find them and went down the hole far to the southwest. ...',
		...
		'I heard that they can kill humans with only one hit! And that they have magic abilities twenty times stronger than the mightiest sorcerer in our world.'}, cid)
	end
	return true
end
