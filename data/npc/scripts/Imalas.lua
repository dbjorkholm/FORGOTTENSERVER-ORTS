...
keywordHandler:addKeyword({'food'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I offer quite a lot of food. Ask me for a {trade} if you're hungry"})
