...
local travelNode = keywordHandler:addKeyword({'liberty bay'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to travel back to Liberty Bay?'})
...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Just ask me for a passage to {Liberty Bay} once you want to leave Goroma.'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Just ask me for a passage to {Liberty Bay} once you want to leave Goroma.'})
