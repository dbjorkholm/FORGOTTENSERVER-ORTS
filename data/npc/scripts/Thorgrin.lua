...
local travelNode = keywordHandler:addKeyword({'cormaya'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'DDo you seek a ride to Cormaya for 110 gold coins?'})
