...
local travelNode = keywordHandler:addKeyword({'peg leg'}, TravelLib.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Ohhhh. So... <lowers his voice> \'you know who\' sent you so I sail you to \'you know where\'. <wink> <wink> It will cost %s to cover my expenses. Is it that what you wish?', cost = 50, discount = TravelLib.postmanDiscount})
...
local travelNode = keywordHandler:addKeyword({'treasure island'}, TravelLib.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you seek a passage to Treasure Island for %s?', cost = 200, discount = TravelLib.postmanDiscount})
