...
local travelNode = keywordHandler:addKeyword({'kazordoon'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to Kazordoon to try the beer there? %s gold?', cost = 160, discount = TravelLib.postmanDiscount})
