...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I am... a traveler. Just leave me alone if you have nothing {interesting} to talk about."})
keywordHandler:addKeyword({'want'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I am... a traveler. Just leave me alone if you have nothing {interesting} to talk about."})
...
keywordHandler:addKeyword({'hugo'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Yes, that's my name of course."})
...
keywordHandler:addKeyword({'carlin'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I never was there. Now leave me alone."})
...
keywordHandler:addKeyword({'eclesius'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "He often comes here. But his constant confusion gives me a worse headache than Frodo's beer. I rather avoid him."})
keywordHandler:addKeyword({'karl'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Uhm, never heard about him... and you can't prove otherwise."})
