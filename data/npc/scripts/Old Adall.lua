...
local travelNode = keywordHandler:addKeyword({'east'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you seek a passage to the east end of Port Hope for 7 gold?'})
...
local travelNode = keywordHandler:addKeyword({'west'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you seek a passage to the west end of Port Hope for 7 gold?'})
