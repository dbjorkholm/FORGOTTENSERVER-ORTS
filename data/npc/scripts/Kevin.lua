...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(250) < 1 then
		...
		elseif player:getStorageValue(250) == 1 or player:getStorageValue(250) == 2 then
			if player:getStorageValue(251) == 1 and player:getStorageValue(252) == 1 and player:getStorageValue(253) == 1 and player:getStorageValue(254) == 1 then
				...
				player:setStorageValue(250, 2)
				npcHandler.topic[cid] = 8
			end
		elseif player:getStorageValue(250) == 4 then
		...
		elseif player:getStorageValue(250) == 6 then
		...
		elseif player:getStorageValue(250) == 12 then
		...
		elseif player:getStorageValue(250) == 24 then
			npcHandler:say("Excellent! Another job well done! Would you accept another mission?", cid)
			player:setStorageValue(250, 25)
			npcHandler.topic[cid] = 19
		elseif player:getStorageValue(250) == 26 then
	...
	elseif(msgcontains(msg, "dress pattern")) then
		if player:getStorageValue(250) == 14 then
			...
			player:setStorageValue(250, 15)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(250) == 16 then
			...
			player:setStorageValue(250, 17)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(250) == 18 then
		...
		elseif player:getStorageValue(250) == 22 then
