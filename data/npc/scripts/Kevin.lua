...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "advancement") then
		if player:getStorageValue(Storage.postman.Mission04) == 2 and player:getStorageValue(Storage.postman.rank) != 1 and player:getStorageValue(Storage.postman.rank) != 2 and player:getStorageValue(Storage.postman.rank) != 3 and player:getStorageValue(Storage.postman.rank) != 4 then
