...
keywordHandler:addKeyword({'business'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I am the leader of the Kuridai and the Az\'irel of Ab\'Dendriel. Humans would call it {sheriff}, executioner, or avenger.'})
...
keywordHandler:addKeyword({'magic'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I mastered some battle spells.'})
...
keywordHandler:addKeyword({'druid'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Druidic magic is too peaceful for my taste.'})
...
keywordHandler:addKeyword({'dwarfs'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'We might use the shelter earth and hills provide us, but their obsession for metal is a waste of time.'})
keywordHandler:addKeyword({'trolls'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Like all inferior races, they can be at least of use for something good. The other castes are just jealous of us making use of them.'})
keywordHandler:addKeyword({'excalibug'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I still doubt it exists.'})
keywordHandler:addKeyword({'ferumbras'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Even if he\'d walk through the town above, the other castes would not see the necessity to follow OUR way.'})
...
keywordHandler:addKeyword({'cenath'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Arrogant bastards, but they wield quite powerful magic.'})
...
keywordHandler:addKeyword({'deraisim'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Confused cowards. For all their skill, they still tend to hide and run. What a waste.'})
...
keywordHandler:addKeyword({'thais'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'The Thaian kingdom and we share some enemies, so it\'s only logical to cooperate in a few areas.'})
keywordHandler:addKeyword({'carlin'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = ''})
keywordHandler:addKeyword({'offer'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I offer hardly anything except for knowledge of {spells}.'})
keywordHandler:addKeyword({'buy'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I offer hardly anything except for knowledge of {spells}.'})
keywordHandler:addKeyword({'sell'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I offer hardly anything except for knowledge of {spells}.'})
