...
keywordHandler:addKeyword({'meat'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I can offer you ham or meat. If you'd like to check the quality of my wares, ask me for a {trade}."})
