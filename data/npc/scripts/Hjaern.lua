...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue( 121) == 4 then
		...
		elseif player:getStorageValue( 121) == 31 then
		...
		elseif player:getStorageValue( 121) == 38 then
			...
			player:setStorageValue( 121, 39)
			player:addItem( 7289, 1)
			talkState[talkUser] = 0
		elseif player:getStorageValue( 121) == 39 then
			for i = 100, 103 do
	...
	elseif msgcontains(msg, "shard") then
		if player:getStorageValue( 121) == 40 then
			npcHandler:say("Do you bring frostheart shards for our spell?", player)
			talkState[talkUser] = 3
		elseif player:getStorageValue( 121) == 42 then
			npcHandler:say("Do you bring frostheart shards for our spell? ", player)
			talkState[talkUser] = 4
		elseif player:getStorageValue( 121) == 44 then
	...
	elseif msgcontains(msg, "reward") then
		if player:getStorageValue( 121) == 41 then
			...
			player:setStorageValue( 121, 42)
			talkState[talkUser] = 3
		elseif player:getStorageValue( 121) == 43 then
			...
			player:setStorageValue( 121, 44)
			talkState[talkUser] = 4
		end
	elseif msgcontains(msg, "tylaf") then
		if player:getStorageValue( 121) == 37 then
