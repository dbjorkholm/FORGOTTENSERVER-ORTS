...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(1060) == 27 then
			npcHandler:say("You made it! Az zoon az you are prepared, I will brief you for your nexzt mizzion. ", cid)
			player:setStorageValue(1060, 28)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(1060) == 28 then
		...
		elseif player:getStorageValue(1060) == 31 then
			...
			player:setStorageValue(1060, 32)
			player:setStorageValue(1090, 1)
			player:addItem(12318, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(1060) == 35 then
	...
	elseif(msgcontains(msg, "yes")) then
		if(npcHandler.topic[cid] == 1) then
			...
			player:setStorageValue(1060, 29)
		...
		elseif(npcHandler.topic[cid] == 3) then
			...
			player:setStorageValue(1060, 36)
			npcHandler.topic[cid] = 0
		end
	end
	return true
