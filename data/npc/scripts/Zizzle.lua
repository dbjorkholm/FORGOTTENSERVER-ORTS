...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		if player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 27 then
			npcHandler:say("You made it! Az zoon az you are prepared, I will brief you for your nexzt mizzion. ", cid)
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 28)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 28 then
		...
		elseif player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 31 then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 32)
			player:setStorageValue(1090, 1)
			player:addItem(12318, 1)
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(Storage.wrathOfTheEmperorQuest) == 35 then
	...
	elseif(msgcontains(msg, "yes")) then
		if(npcHandler.topic[cid] == 1) then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 29)
		...
		elseif(npcHandler.topic[cid] == 3) then
			...
			player:setStorageValue(Storage.wrathOfTheEmperorQuest, 36)
			npcHandler.topic[cid] = 0
		end
	end
	return true
