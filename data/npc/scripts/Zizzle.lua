...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		...
		elseif player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 31 then
			...
			npcHandler.topic[cid] = 0
		elseif player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 35 then
	...
	elseif(msgcontains(msg, "yes")) then
		...
		elseif(npcHandler.topic[cid] == 3) then
			...
			player:setStorageValue(Storage.WrathoftheEmperor.Questline, 36)
			npcHandler.topic[cid] = 0
		end
	end
	return true
