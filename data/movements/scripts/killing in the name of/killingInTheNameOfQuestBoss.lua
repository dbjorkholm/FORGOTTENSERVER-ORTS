...
local bosses = {
	...
	[3236] = {bossName = "fleshcrawler 	", storage = 35006, playerPos = {x = 33100, y = 32785, z = 11}, bossPos = {x = 32121, y = 32797, z = 11 },  fromPos = {x = 33091, y = 32773, z = 11 }, toPos = {x = 33129, y = 32809, z = 11 }, flamePos = {x = 33106, y = 32775, z = 11}},
	...
	[3238] = {bossName = "bloodweb", storage = 35008, playerPos = {x = 32019, y = 31038, z = 8}, bossPos = {x = 32032, y = 31033, z = 8 },  fromPos = {x = 32003, y = 31014, z = 8 }, toPos = {x = 32040, y = 31047, z = 8 }, flamePos = {x = 32010, y = 31031, z = 8}},
	...
	[3243] = {bossName = "flameborn", storage = 35013, playerPos = {x = 0, y = 0, z = 0}, bossPos = {x = 0, y = 0, z = 0 },  fromPos = {x = 0, y = 0, z = 0 }, toPos = {x = 0, y = 0, z = 0 }, flamePos = {x = 0, y = 0, z = 0}},
	...
	[3246] = {bossName = "sulphur scuttler", storage = 35016, playerPos = {x = 0, y = 0, z = 0}, bossPos = {x = 0, y = 0, z = 0 },  fromPos = {x = 0, y = 0, z = 0 }, toPos = {x = 0, y = 0, z = 0 }, flamePos = {x = 0, y = 0, z = 0}},
	[3247] = {bossName = "bruise payne", storage = 35017, playerPos = {x = 0, y = 0, z = 0}, bossPos = {x = 0, y = 0, z = 0 },  fromPos = {x = 0, y = 0, z = 0 }, toPos = {x = 0, y = 0, z = 0 }, flamePos = {x = 0, y = 0, z = 0}},
