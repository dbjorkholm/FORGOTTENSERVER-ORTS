...
function onStepIn(cid, item, position, fromPosition)
	...
	if (newPit > 10) then
		...
		doCreatureSay(cid, (arena == 1 and "Welcome back, little hero!" or arena == 2 and "Congratulations, brave warrior!" or "Respect and honour to you, champion!"), TALKTYPE_MONSTER_SAY)
		stopEvent(e10)
	return true
	end
	...
	if (item.actionid == 25300) then
		...
		doTeleportThing(cid, POSITION_KICK)
		doCreatureSay(cid, "Coward!", TALKTYPE_MONSTER_SAY)
		stopEvent(e2)
		stopEvent(e3)
		stopEvent(e4)
		stopEvent(e5)
