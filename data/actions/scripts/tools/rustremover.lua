...
local CHAIN_HELMET, BRASS_HELMET, LEGION_HELMET, SOLDIER_HELMET, STEEL_HELMET, CROWN_HELMET, CRUSADER_HELMET, WARRIOR_HELMET, ROYAL_HELMET = 2458, 2460, 2480, 2481, 2457, 2491, 2497, 2475, 2498
...
local config = {
	...
	[9817] = { -- common rusty boots
		{{1, 30000}},
		{{30001, 60000}, LEATHER_BOOTS},
		{{60001, 90000}, CROCODILE_BOOTS}, 
		{{90001, 97000}, PIRATE_BOOTS}, 
		{{97001, 100000}, FUR_BOOTS}
	},
	[9818] = { -- semi-rare rusty boots
		...
		{{60001, 90000}, CROCODILE_BOOTS}, 
		{{90001, 97000}, PIRATE_BOOTS}, 
		{{97001, 99000}, FUR_BOOTS}, 
		{{99001, 100000}, BOOTS_OF_HASTE}
	},
	[9819] = { -- rare rusty boots
		{{1, 30000}},
		{{30001, 50000}, LEATHER_BOOTS},
		{{50001, 80000}, CROCODILE_BOOTS},
		{{80001, 87000}, PIRATE_BOOTS},
		{{87001, 98000}, FUR_BOOTS},
		{{98001, 99000}, BOOTS_OF_HASTE},
		{{99001, 100000}, STEEL_BOOTS}
	},
	[9820] = { -- common rusty helmet
		{{1, 30000}},
		{{30001, 50000}, CHAIN_HELMET},
		{{50001, 80000}, BRASS_HELMET},
		{{80001, 87000}, LEGION_HELMET},
		{{87001, 98000}, SOLDIER_HELMET},
		{{98001, 99000}, STEEL_HELMET},
		{{99001, 100000}, CROWN_HELMET}
	},
	[9821] = { -- semi-rare rusty helmet
		{{1, 40000}},
		{{40001, 60000}, CHAIN_HELMET},
		{{60001, 75000}, BRASS_HELMET},
		{{75001, 87500}, LEGION_HELMET},
		{{87501, 95500}, SOLDIER_HELMET},
		{{95501, 98250}, STEEL_HELMET},
		{{98251, 99250}, CROWN_HELMET},
		{{99251, 100000}, CRUSADER_HELMET}
	},
	[9822] = { -- rare rusty helmet
		{{1, 50000}}, 
		{{50001, 60000}, CHAIN_HELMET},
		{{60001, 70000}, BRASS_HELMET}, 
		{{70001, 80000}, LEGION_HELMET}, 
		{{80001, 87500}, SOLDIER_HELMET}, 
		{{87501, 93000}, STEEL_HELMET},
		{{93001, 96000}, CROWN_HELMET},
		{{96000, 97000}, CRUSADER_HELMET},
		{{96001, 98500}, WARRIOR_HELMET},
