function onUse(cid, item, fromPosition, itemEx, toPosition)
	if(item.uid == 3181) then
		if(getPlayerItemCount(cid, 12324) >= 1 and getPlayerItemCount(cid, 12325) >= 1 and getPlayerItemCount(cid, 12326) >= 1 and getPlayerStorageValue(cid, 1060) == 10) then
			...
			setPlayerStorageValue(cid, 1060, 11)
		end
	end
	return true
end
